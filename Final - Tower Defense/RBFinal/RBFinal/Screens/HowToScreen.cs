...
namespace RBFinal.Screens
{
    public class HowToScreen : Screen
    {
        ...
        public HowToScreen(TowerDefense towerDefense) : base(towerDefense)
        {
            ...
            backButton = new Button(towerDefense,
                    ...
                    (b, m) =>
                    {
                        ...
                        {
                            hide();
                            ScreenHandler.showScreen(this, ScreenHandler.LastScreen);
                        }
                    },
        ...
        {
            SpriteBatch.Begin();
            SpriteHandler.BkgHowTo.draw(SpriteBatch, new Vector2(0, 0));
